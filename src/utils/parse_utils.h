...
#ifndef UTILS_PARSE_UTILS_H_
#define UTILS_PARSE_UTILS_H_
...
HOST_PREFIX void loadTransformations(vector<Transform3f>& transforms, const string filename);
